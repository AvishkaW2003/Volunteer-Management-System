...
const UnifiedAuthPage = ({ initialTab = 'login', initialRole = 'student' }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center px-4 pt-24 pb-12">
      ...
      {/* Main Container Card (Single Focused Form) */}
      <div className="bg-white w-full max-w-md rounded-3xl shadow-xl overflow-hidden border border-gray-100 p-8 md:p-10 flex flex-col justify-start">
          ...
          <p className="text-gray-500 text-xs mb-6">
            {activeTab === 'login' 
              ...
              : `Fill in your details to register as a ${activeRole}`}
          </p>
          ...
          {activeTab === 'login' ? (
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-3 rounded-xl text-white font-bold text-sm transition-all duration-200 mt-2 disabled:opacity-60 cursor-pointer ${
