            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-3.5">
              ...
              <div className="mt-3 flex flex-col items-center justify-center w-full">
                ...
                <div className="w-full flex flex-col items-center gap-2">
                  <div id="google-signin-btn-page" className="w-full flex justify-center min-h-[44px]"></div>
                  <button
                    type="button"
                    onClick={handleCustomGoogleClick}
                    className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 font-extrabold text-sm shadow-sm transition-all cursor-pointer active:scale-[0.99]"
                  >
                    <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="none">
                      <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
                      <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
