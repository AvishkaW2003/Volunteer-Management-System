    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* Section 5: Volunteer Preferences */}
          <SectionCard icon={Award} title="Volunteer Preferences">
            <p className="text-xs text-gray-500 -mt-2 mb-4">
              Select category preferences. We use these to recommend suitable community service events.
            </p>
          ...
          <SectionCard icon={Clock} title="Availability">
            <p className="text-xs text-gray-500 -mt-2 mb-4">
              Specify availability days and times to help event organizers identify fitting vacancies.
            </p>
            <div className="space-y-5">
              <div>
                <h4 className="text-xs font-bold text-gray-700 mb-2.5">Days:</h4>
              ...
              <div>
                <h4 className="text-xs font-bold text-gray-700 mb-2.5">Time of Day:</h4>
                <div className="flex flex-wrap gap-3">
                  {['Morning', 'Afternoon', 'Evening'].map((time) => {
                    const active = (availability.times || []).includes(time);
                    return (
                      <button
                        key={time}
                        type="button"
          ...
          <SectionCard icon={Bell} title="Notification Preferences">
            <div className="space-y-4">
              <CustomToggle
                ...
                onChange={() => setNotifications({ ...notifications, eventRecommendations: !notifications.eventRecommendations })}
              ...
              <CustomToggle
                ...
                onChange={() => setNotifications({ ...notifications, eventReminders: !notifications.eventReminders })}
                label="Event Reminders"
              />
              <CustomToggle
                checked={notifications.certificateNotifications}
                onChange={() => setNotifications({ ...notifications, certificateNotifications: !notifications.certificateNotifications })}
                label="Certificate Notifications"
              />
              <CustomToggle
                checked={notifications.reputationPointUpdates}
                onChange={() => setNotifications({ ...notifications, reputationPointUpdates: !notifications.reputationPointUpdates })}
                label="Reputation Point Updates"
              />
            </div>
          </SectionCard>

          {/* Section 8: Privacy Settings */}
          <SectionCard icon={Shield} title="Privacy Settings">
            <div className="space-y-4">
              <CustomToggle
                checked={privacy.showProfileOnLeaderboard}
                onChange={() => setPrivacy({ ...privacy, showProfileOnLeaderboard: !privacy.showProfileOnLeaderboard })}
                label="Show Profile on Volunteer Leaderboard"
              />
              <CustomToggle
                checked={privacy.allowOrganizersToViewSkills}
                onChange={() => setPrivacy({ ...privacy, allowOrganizersToViewSkills: !privacy.allowOrganizersToViewSkills })}
                label="Allow Organizers to View Skills"
              />
              <CustomToggle
                checked={privacy.receivePersonalizedRecommendations}
                onChange={() => setPrivacy({ ...privacy, receivePersonalizedRecommendations: !privacy.receivePersonalizedRecommendations })}
