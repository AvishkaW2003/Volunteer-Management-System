...
const Dashboard = () => {
  return (
    <div className="flex h-screen font-sans text-gray-800 bg-gray-50">
      ...
      {/* SIDEBAR */}
      <aside className="flex flex-col justify-between w-64 bg-white border-r border-gray-200">
        <div>
      ...
      <main className="flex flex-col flex-1 overflow-hidden">
        ...
        <header className="flex items-center justify-between h-20 px-8 bg-white border-b border-gray-200">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-gray-200">
              ...
              <div className="w-10 h-10 overflow-hidden bg-gray-300 border-2 border-white rounded-full shadow-sm">
        ...
        <div className="flex-1 p-8 overflow-y-auto">
          ...
          {/* WELCOME BANNER */}
          <div className="relative flex items-center justify-between p-8 mb-8 overflow-hidden text-white bg-blue-600 shadow-sm rounded-2xl">
            <div className="z-10">
              <h2 className="mb-2 text-2xl font-semibold">Welcome back, user!</h2>
              <p className="max-w-lg mb-6 text-sm text-blue-100">
            ...
            <div className="absolute pointer-events-none right-10 opacity-20">
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="col-span-2 space-y-8">
              ...
              {/* Recommended For You */}
              <div className="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
                <h3 className="mb-6 font-semibold text-gray-800">Recommended for You</h3>
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 text-center bg-white border border-gray-200 shadow-sm rounded-2xl">
                <h3 className="mb-6 font-semibold text-left text-gray-800">Reputation Level</h3>
                <div className="inline-flex items-center justify-center w-16 h-16 mb-4 bg-blue-100 rounded-full">
                  <Award className="text-blue-600" size={32} />
                </div>
                <h4 className="text-lg font-bold text-gray-800">Gold Member</h4>
                <p className="mb-6 text-sm text-gray-500">180 points to Platinum</p>
              ...
              <div className="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
                <h3 className="mb-6 font-semibold text-gray-800">Recent Participation</h3>
                <div className="relative ml-3 space-y-6 border-l-2 border-gray-100">
                  <TimelineItem 
                    date="Yesterday" 
                ...
                <button className="w-full py-2 mt-8 text-sm font-medium text-gray-600 transition border border-gray-200 rounded-lg hover:bg-gray-50">
                  Download Report
                </button>
              </div>
      ...
      <button className="fixed p-4 text-white transition bg-blue-600 rounded-full shadow-lg bottom-8 right-8 hover:bg-blue-700">
        <Plus size={24} />
      </button>
...
const StatCard = ({ icon, value, label, badge, badgeColor }) => (
  <div className="flex flex-col justify-between h-32 p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
...
const EventListItem = ({ category, title, date, location, image }) => (
  <div className="flex items-center justify-between p-4 transition border border-gray-100 cursor-pointer rounded-xl hover:border-blue-100 group">
    <div className="flex items-center gap-4">
      <img src={image} alt={title} className="object-cover w-16 h-16 rounded-lg" />
      <div>
        <span className="inline-block px-2 py-1 mb-2 text-xs font-medium text-blue-600 rounded-md bg-blue-50">{category}</span>
    ...
    <ChevronRight className="text-gray-400 transition group-hover:text-blue-600" size={20} />
  </div>
);

const RecommendedCard = ({ category, slots, title, desc, image }) => (
  <div className="flex flex-col overflow-hidden transition border border-gray-100 rounded-xl group hover:shadow-md">
    <div className="relative h-32 overflow-hidden">
      <img src={image} alt={title} className="object-cover w-full h-full transition duration-500 group-hover:scale-105" />
    </div>
    <div className="flex flex-col flex-1 p-5">
      <div className="flex items-center justify-between mb-3">
        <span className="px-2 py-1 text-xs font-medium text-blue-600 rounded-md bg-blue-50">{category}</span>
        <span className="text-xs text-gray-500">{slots}</span>
      </div>
      <h4 className="mb-2 text-sm font-semibold text-gray-800">{title}</h4>
      <p className="flex-1 mb-5 text-xs text-gray-500 line-clamp-2">{desc}</p>
      <button className="w-full py-2 mt-auto text-sm font-medium text-blue-600 transition border border-blue-600 rounded-lg hover:bg-blue-50">
        Apply Now
      </button>
    </div>
  </div>
