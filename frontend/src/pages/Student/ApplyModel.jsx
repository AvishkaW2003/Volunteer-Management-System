...
const ApplyModal = ({ event, onClose }) => {
  const [form, setForm] = useState({
    name: '', email: '', phone: '', skills: '', motivation: '', experience: '', agreed: false,
  });
  ...
  const handleSubmit = e => {
    e.preventDefault();
    if (!canSubmit) return;
    // TODO: POST /api/applications with form + event.id
    setSubmitted(true);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="you@university.edu" className={inputCls} required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="+1 (555) 000-0000" className={inputCls} required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., First Aid, Communication, Teaching" className={inputCls}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  name="experience" value={form.experience} onChange={handleChange} rows={3}
                  placeholder="Tell us about any past volunteering experience (optional)..."
              ...
              <label className="flex items-start gap-3 p-4 rounded-xl border border-gray-100
                ...
                <span className="text-sm text-gray-600">
                  I agree to the volunteer code of conduct and confirm that the information above is accurate.
                </span>
              </label>
